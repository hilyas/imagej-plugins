...
public class Harris_Corner_Detector_modified implements PlugInFilter {
	ImagePlus im;
	...
	static double mydmin = HarrisCornerDetector.DEFAULT_DMIN;
	...
	private boolean showDialog() {
		...
		double def_dmin = HarrisCornerDetector.DEFAULT_DMIN;
		dlg.addNumericField("DMIN ", mydmin, 3);
		...
		if(alpha > 0.25){
			IJ.showMessage("Your alpha is larger than 0.25, exiting...");
			//System.exit(0);
			return false;
		}
